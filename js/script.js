...
function initSocialShare() {
  ...
  box.innerHTML =
    ...
    '<a href="https://pinterest.com/pin/create/button/?url=' + url + '&description=' + title + '&media=' + encodeURIComponent((document.querySelector('meta[property="og:image"]') || {content:''}).content) + '" target="_blank" rel="noopener noreferrer" class="share-btn share-pinterest"><i class="fab fa-pinterest-p"></i> Pinterest</a>' +
